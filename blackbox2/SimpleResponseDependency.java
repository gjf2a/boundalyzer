...
public class SimpleResponseDependency extends ResponseDependency {

    public SimpleResponseDependency(HistoryPattern basis, boolean negated) {
        super(basis, negated);
    }
    ...
    public String toString() {
        return notFilter(getBasis().toString());
    }
