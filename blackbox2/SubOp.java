...
public class SubOp extends CountingOp {
    public SubOp(CountingPattern left, CountingPattern right) {
        super(left, right);
    }
	...
	protected AbstractHistoryPattern reconstructed(ArrayList<AbstractHistoryPattern> children) {
		...
		return new SubOp((CountingPattern)children.get(0), (CountingPattern)children.get(1));
	}
}
